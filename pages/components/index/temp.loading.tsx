    ...
    return ( 
        <Wrapper>
            ...
            <List>
                <Item>
                    <Left>Mandag</Left>
                    <Right>Forloren hare m/ walddorfsalat, kartofler og sovs</Right>
                </Item>
                <Item>
                    <Left>Tirsdag</Left>
                    <Right>Forårsruller m/ris og sur, sød sovs</Right>
                </Item>
                <Item>
                    <Left>Onsdag</Left>
                ...
                <Item>
                    <Left>Torsdag</Left>
                    <Right>Kylling m/pasta og choron sovs</Right>
                </Item>
                <Item>
                    <Left>Fredag</Left>
                    <Right>Ribensburger m/ bådkartofler</Right>
                </Item>
                <Item>
                    <Left>Lørdag</Left>
